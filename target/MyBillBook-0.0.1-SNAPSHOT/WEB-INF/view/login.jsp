...
<!-- Dark Theme Toggle -->
<div class="dark-toggle" onclick="toggleTheme()" title="Toggle dark/light mode">
            ...
            <div class="card">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="login" role="tabpanel">
                        <form method="POST" action="${contextPath}/login" novalidate autocomplete="off">
                            ...
                            <div class="form-group-icon mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="password" class="form-control" id="password" name="password"
                                           placeholder="Password" required minlength="6" autocomplete="off">
                    ...
                    <div class="tab-pane fade" id="register" role="tabpanel">
                        <form:form method="POST" modelAttribute="userForm" action="${contextPath}/registration" onsubmit="return validateRegistrationForm();" autocomplete="off">
                            <div class="form-group-icon mb-3">
                                <i class="fa fa-user form-icon"></i>
                                <div class="form-floating">
                            ...
                            <div class="form-group-icon mb-3">
                                ...
                                <div class="form-floating">
                                    ...
                                    <div id="passwordMismatch" class="error d-none">Passwords do not match</div>
                                </div>
                            </div>

                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <button type="submit" id ="registerBtn" class="btn btn-success w-100 btn-rounded">Register</button>
                        </form:form>
                    </div>
                </div>
            </div>
