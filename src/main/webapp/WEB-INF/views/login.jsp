  ...
  <div class="card">
    ...
    <form method="POST" action="${contextPath}/login" >
      <div class="input-container">
        <input type="text" name="username" required="required" id="Username" required="required" autofocus="true"/>
        <label for="Username">Username</label>
        <div class="bar"></div>
      </div>
      <div class="input-container">
        <input type="password" name="password" required="required"  id="Password" required="required"/>
...
<!-- Portfolio--><a id="portfolio" title="View my portfolio!"><i class="fa fa-link"></i></a>
	</div>
</div>
<script>
