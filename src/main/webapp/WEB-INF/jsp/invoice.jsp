...
<html>
   ...
   <body>
      <c:if test="${pageContext.request.userPrincipal.name != null}">
         ...
         <h6 style="text-align: center;">--------------------------- Customer Copy --------------------------</h6>
         <div >
            <div class="row" >
               <div class="col-sm-12" >
            ...
            <div class="row">
               <div class="col-xs-12 table-responsivetable-responsive">
         ...
         <c:if test="${oldinvoices.size() > 0}">
          <h6 style="text-align: center;">---------------------------Older invoices Details--------------------------</h6>
            <div class="row">
               <div class="col-xs-12 table-responsive" style=" font-size: smaller; ">
         ...
         <h6 style="text-align: center;">--------------------------- Merchant copy --------------------------</h6>
               ...
               <div class="col-xs-12 " style=" font-size: smaller; ">
                  <table class="table table-responsive" >
                     <thead>
                        <tr>
                           <th>Invoice No</th>
                           <th>Items Description(Current Invoice)</th>
                           <th>Bill Amt</th>
                           <th>Adv Amt</th>
                           <th>Bal</th>
                           <th>Date</th>
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td>${currentinvoiceitems.date}</td>
                           </td>
                        </tr>
                     </tbody>
                  </table>
         ...
         <div class="row no-print border border-primary"
            ...
            <%-- <div class="col-xs-3"></div>
               <form id="doc-upload-form" action="${pageContext.request.contextPath}/company/upload-invoice-pdf" method="post"
               role="form" modelAttribute="DOCSUP" enctype="multipart/form-data">
               <div class="col-xs-4">
               	<input class="form-control" name="file" type="file"  accept="application/pdf"  id="formFile" multiple onchange="GetFileSizeNameAndType()" style="background-color: aliceblue;">
               </div>
               <input type="hidden" id="invoiceNumber" name="invoiceNo" value="${invoiceNo}" >
               <div class="col-xs-2">
               	<button id="btn-upload" class="btn btn-success pull-right"
